...
Prometheus exporter for Kasa smart plugs.

## Source Code

* <https://github.com/thelande/kasa_exporter>
...
| image.repository | string | `"thelande/kasa_exporter"` |  |
| image.tag | string | `""` |  |
...
| probes | list | `[]` | List of devices to be probed. Each entry should have a `name`, `address`, and `scrapeInterval` field. |
